...
void registerEvents(ALLEGRO_EVENT_QUEUE* eventos, ALLEGRO_DISPLAY* display, ALLEGRO_TIMER* timer, ALLEGRO_TIMER* temp) {
    al_install_mouse();
    al_install_keyboard();
    ...
    al_register_event_source(eventos, al_get_timer_event_source(temp));
}