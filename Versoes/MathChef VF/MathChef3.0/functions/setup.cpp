...
setup* configSetup(setup* config, int op) {
    ...
    config->timer = al_load_bitmap("img/timer.png");
    ...
    if (op == 1) {
        ...
        config->fundoF = al_load_bitmap("img/fundo-fsoma.png");
    ...
    if (op == 2) {
        ...
        config->fundoF = al_load_bitmap("img/fundo-fsub.png");
    ...
    if (op == 3) {
        ...
        config->fundoF = al_load_bitmap("img/fundo-fdiv.png");
    ...
    if (op == 4) {
        ...
        config->fundoF = al_load_bitmap("img/fundo-fmult.png");
